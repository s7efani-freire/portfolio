...
export const projects: Project[] = [
  ...
  },
  {
    ...
    tech: ['PHP', 'Laravel', 'MySQL', 'TOTVS/Protheus (integração)'],
    type: 'corporate',
  },
  {
    ...
    tech: ['React', 'TypeScript', 'Laravel', 'MySQL', 'Esp32', 'RFID'],
    type: 'corporate',
  },
  {
  ...
  {
    title: { pt: 'Plataforma de Compliance Corporativo', en: 'Corporate Compliance Platform' },
    description: {
      pt: 'Canal interno para registro e acompanhamento de denúncias e solicitações, com fluxo de auditoria e controle de acesso por perfil.',
      en: 'Internal channel for logging and tracking reports and requests, with an audit trail and role-based access control.',
    },
  ...
  },
  {
    ...
    tech: ['Laravel', 'PHP', 'MySQL', 'TOTVS/Protheus (integração)'],
    type: 'corporate',
  },
  {
    ...
    tech: ['React', 'TypeScript', 'Laravel', 'MySQL', 'Biometria Facial'],
    type: 'corporate',
  },
];
