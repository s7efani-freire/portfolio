      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-white to-orange-400 bg-clip-text text-transparent">
            {tr(strings.contact.heading)}
          </h2>
          <div className="w-24 h-1 bg-gradient-to-r from-purple-600 to-orange-500 mx-auto"></div>
        </div>

        <div className="max-w-2xl mx-auto text-center">
          <p className="text-xl text-gray-200 mb-12 leading-loose">{tr(strings.contact.intro)}</p>
          ...
          <div className="grid gap-4" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(18rem, 1fr))' }}>
            ...
            >
              ...
              <h3 className="text-lg font-semibold mb-2">{tr(strings.contact.phone)}</h3>
            ...
            >
              ...
              <h3 className="text-lg font-semibold mb-2">{tr(strings.contact.email)}</h3>
            ...
            >
              ...
              <h3 className="text-lg font-semibold mb-2">{tr(strings.contact.github)}</h3>
            ...
            >
              ...
              <h3 className="text-lg font-semibold mb-2">{tr(strings.contact.linkedin)}</h3>
